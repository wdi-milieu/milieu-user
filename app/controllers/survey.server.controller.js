...
module.exports = {
  ...
  index: function(req, res, next) {
    ...
    for(var j = 0; j < totalCount.length; j++)  {
      ...
      "NPS_Score": (brandIndex.promoters/brandIndex.total * 100) - (brandIndex.detractors/brandIndex.total * 100),
      "NPS_Reason1": (brandIndex.npsReason1/brandIndex.total * 100) + "%",
      "NPS_Reason2": (brandIndex.npsReason2/brandIndex.total * 100) + "%",
      "NPS_Reason3": (brandIndex.npsReason3/brandIndex.total * 100) + "%",
     });
    }
